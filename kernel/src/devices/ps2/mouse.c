...
void mouse_handler()
{
    serial_puts("mouse_handler(IRQ12) Interrupt raised!");
...
int init_mouse(int scrwidth, int scrheight) {
    uint8_t status;

    serial_puts("init_mouse() Setting up values...");
    g_mouse_x_pos = 5;
    g_mouse_y_pos = 2;
    ...
    // enable mouse device
    serial_puts("init_mouse() Enabling PS2 mouse...");
    mouse_wait(TRUE);
    ...
    serial_puts("init_mouse() Enabling PS2 mouse interrupt...");
    mouse_wait(TRUE);
    ...
    serial_puts("init_mouse() Set mouse to use default settings...");
    ...
    serial_puts("init_mouse() Setting up IDT entry...");
    idt_set_entry(0x2C, mouse_handler, 0);
    serial_puts(" OK\n");
